package sonframework.policy.login.filter;
...
public class SysLoginPolicyFilter implements Filter {

	private FilterConfig config;

    private static final Logger LOGGER = LoggerFactory.getLogger(SysLoginPolicyFilter.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		SysLoginPolicyService sysLoginPolicyService = (SysLoginPolicyService) act.getBean("sysLoginPolicyService");
		...
		try {
			...
			loginPolicyVO = sysLoginPolicyService
