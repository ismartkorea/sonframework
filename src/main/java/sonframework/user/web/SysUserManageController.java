...
import sonframework.user.service.SysUserManageService;
import sonframework.user.service.UserDefaultVO;
import sonframework.user.service.UserManageVO;
...
public class SysUserManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/user/SysUserManage.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/user/SysUserInsertView.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/user/SysUserSelectUpdtView.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/user/SysUserPasswordUpdt.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/user/SysUserPasswordUpdtView.do")
