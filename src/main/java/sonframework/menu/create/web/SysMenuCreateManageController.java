package sonframework.menu.create.web;
...
import sonframework.menu.create.service.MenuCreatVO;
import sonframework.menu.create.service.SysMenuCreateManageService;
...
public class SysMenuCreateManageController {
	...
	private SysMenuCreateManageService menuCreateManageService;
	 ...
	 * @param searchVO
	 *            ComDefaultVO
	 * @return 출력페이지정보 "sym/mnu/mcm/SysMenuCreatManage"
	 * @exception Exception
	 */
	@RequestMapping(value = "/menu/create/SysMenuCreatManageSelect.do")
	public String selectMenuCreatManagList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "sym/mnu/mcm/SysMenuCreatManage";
	}
	 ...
	 * @param menuCreatVO
	 *            MenuCreatVO
	 * @return 출력페이지정보 "sym/mnu/mcm/SysMenuCreat"
	 * @exception Exception
	 */
	@RequestMapping(value = "/menu/create/SysMenuCreatSelect.do")
	public String selectMenuCreatList(@ModelAttribute("menuCreatVO") MenuCreatVO menuCreatVO, ModelMap model) throws Exception {
		...
		return "sym/mnu/mcm/SysMenuCreat";
	}
	 ...
	 *            String
	 * @return 출력페이지정보 등록처리시 "forward:/menu/create/SysMenuCreatSelect.do"
	 * @exception Exception
	 */
	@RequestMapping("/menu/create/SysMenuCreatInsert.do")
	public String insertMenuCreatList(@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert, @RequestParam("checkedMenuNoForInsert") String checkedMenuNoForInsert,
		...
		model.addAttribute("resultMsg", resultMsg);
		return "forward:/menu/create/SysMenuCreatSelect.do";
	}
