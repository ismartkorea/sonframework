...
public class SysUserInfManageDAO extends EgovAbstractMapper {
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectUserList", userVO);
    }
	...
	return (Integer)selectOne("SysUserInfManageDAO.selectUserListCnt", userVO);
    }
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectCmmntyUserList", userVO);
    }
	...
	return (Integer)selectOne("SysUserInfManageDAO.selectCmmntyUserListCnt", userVO);
    }
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectCmmntyMngrList", userVO);
    }
	...
	return (Integer)selectOne("SysUserInfManageDAO.selectCmmntyMngrListCnt", userVO);
    }
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectClubUserList", userVO);
    }
	...
	return (Integer)selectOne("SysUserInfManageDAO.selectClubUserListCnt", userVO);
    }
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectClubOprtrList", userVO);
    }
	...
	return (Integer)selectOne("SysUserInfManageDAO.selectClubOprtrListCnt", userVO);
    }
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectAllClubUser", userVO);
    }
	...
	return (List<UserInfVO>) list("SysUserInfManageDAO.selectAllCmmntyUser", userVO);
    }
}
