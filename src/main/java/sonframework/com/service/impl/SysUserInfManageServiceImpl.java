...
public class SysUserInfManageServiceImpl extends EgovAbstractServiceImpl implements SysUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectClubOprtrList(egovframework.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectClubUserList(egovframework.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectCmmntyMngrList(egovframework.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectCmmntyUserList(egovframework.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectUserList(egovframework.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectAllClubUser(egovframework.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see egovframework.let.SysUserInfManageService.com.service.EgovUserInfManageService#selectAllCmmntyUser(egovframework.let.cop.com.service.UserInfVO)
     */
