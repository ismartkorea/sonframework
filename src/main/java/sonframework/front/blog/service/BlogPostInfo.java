...
public class BlogPostInfo {
	...
	public String toString() {
		return "BlogPostInfo [atchFileId=" + atchFileId + ", bbsId=" + bbsId + ", frstRegisterId=" + frstRegisterId
				+ ", frstRegisterPnttm=" + frstRegisterPnttm + ", lastUpdusrId=" + lastUpdusrId + ", lastUpdusrPnttm="
				+ lastUpdusrPnttm + ", ntceBgnde=" + ntceBgnde + ", ntceEndde=" + ntceEndde + ", ntcrId=" + ntcrId
				+ ", ntcrNm=" + ntcrNm + ", nttCn=" + nttCn + ", nttId=" + nttId + ", nttNo=" + nttNo + ", nttSj="
				+ nttSj + ", parnts=" + parnts + ", password=" + password + ", inqireCo=" + inqireCo + ", replyAt="
				+ replyAt + ", replyLc=" + replyLc + ", sortOrdr=" + sortOrdr + ", useAt=" + useAt + ", ntceEnddeView="
				+ ntceEnddeView + ", ntceBgndeView=" + ntceBgndeView + "]";
	}
